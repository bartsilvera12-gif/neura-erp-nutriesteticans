...
const MENU_STRUCTURE: MenuItem[] = [
  ...
  // Nota de remisión: convivió como ítem propio pero se movió a sub-items bajo
  // "Ventas" (arriba). El gate de ruta /notas-remision se hace por el módulo
  // `ventas` en route-slug-map.ts.
